      ...
      <div className="data-submission-container">
        ...
        <form className="submission-form">
          ...
          <div className="form-group">
            <label htmlFor="texttitle">기본 정보</label>
          </div>
          <div className="form-group">
            <input
              type="제목"
          ...
          <div className="form-group">
            <label htmlFor="texttitle">리워드 정보</label>
          </div>
          <div className="form-group">
            <input
              type="리워드"
          ...
          <div className="Next-button">
            <button type="button" onClick={handleSubmit} style={{ backgroundColor: image ? "#214FC7" : "#A5A5A5" }}>
              생성
            </button>
          </div>
        </form>
